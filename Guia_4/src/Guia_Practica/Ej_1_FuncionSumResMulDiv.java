...
multiplicar y dividir. La aplicación debe tener una función para cada 
operación matemática y deben devolver sus resultados para imprimirlos en el main. 
*/
public class Ej_1_FuncionSumResMulDiv {
    ...
    public static int operacion(){
        ...
        switch (op){
                    ...
                    case 4:
                        ...
                        break;
                     default:
                System.out.println("al no elegir una operacion le daremos un resultado cero");
                resultado=0;
        }
        return resultado;
    }
